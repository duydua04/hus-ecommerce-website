...
\restrict PuW27ExPSLkIlbkEMvd2qcJvb7aEhjwB5W3m5AWIyKJ13WRQDfIqq88lLQPYeHg
...
--
-- Name: conversation; Type: TABLE; Schema: public; Owner: mywebsite
--
...
CREATE TABLE public.conversation (
    ...
    last_message text,
    last_message_at timestamp without time zone DEFAULT (now() AT TIME ZONE 'utc'::text),
    unread_counts jsonb DEFAULT '{"buyer": 0, "seller": 0}'::jsonb
);


ALTER TABLE public.conversation OWNER TO mywebsite;

--
-- Name: conversation_conversation_id_seq; Type: SEQUENCE; Schema: public; Owner: mywebsite
--
...
ALTER SEQUENCE public.conversation_conversation_id_seq OWNER TO mywebsite;

--
-- Name: conversation_conversation_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mywebsite
--
...
--
-- Name: message; Type: TABLE; Schema: public; Owner: mywebsite
--
...
ALTER TABLE public.message OWNER TO mywebsite;

--
-- Name: message_message_id_seq; Type: SEQUENCE; Schema: public; Owner: mywebsite
--
...
ALTER SEQUENCE public.message_message_id_seq OWNER TO mywebsite;

--
-- Name: message_message_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mywebsite
--
...
--
-- Name: conversation conversation_id; Type: DEFAULT; Schema: public; Owner: mywebsite
--
...
--
-- Name: message message_id; Type: DEFAULT; Schema: public; Owner: mywebsite
--
...
6	23001521@hus.edu.vn	9988776655	Hòa	Nguyễn	$2b$12$W3oLhGLzpubNe5mM6dhoZe5scuQ0aHDae0VwyiFCp6PznhoqnNAgG	\N	bronze	t	2025-11-19 16:03:08.356999
...
4	Viettel Post	\N	18000.00	8000.00	t
...
--
-- Data for Name: conversation; Type: TABLE DATA; Schema: public; Owner: mywebsite
--

COPY public.conversation (conversation_id, buyer_id, seller_id, last_message, last_message_at, unread_counts) FROM stdin;
1	1	4	Vậy còn màu trắng thì sao	2025-11-28 07:30:31.218092	{"buyer": 3, "seller": 10}
\.
...
--
-- Data for Name: message; Type: TABLE DATA; Schema: public; Owner: mywebsite
--

COPY public.message (message_id, conversation_id, sender, content, images, is_read, created_at) FROM stdin;
1	1	buyer	Xin chao	[]	f	2025-11-24 16:56:12.786114
2	1	buyer	Xin chao	[]	f	2025-11-24 16:57:23.20016
3	1	buyer	Ban co thay toi khong	[]	f	2025-11-24 17:06:39.254541
4	1	buyer	Tôi cần tư vấn 	[]	f	2025-11-24 17:12:57.33866
5	1	buyer	Bạn có thể giúp tôi không 	[]	f	2025-11-24 17:14:12.754451
6	1	buyer	???	[]	f	2025-11-24 17:14:12.754451
7	1	buyer	Hãy trả lời tôi 	[]	f	2025-11-24 17:20:55.567392
8	1	buyer	Hãy trả lời tôi	[]	f	2025-11-25 02:53:56.575903
9	1	seller	Chào bạn, bạn cần giúp gì	[]	f	2025-11-25 02:53:56.575903
10	1	seller	Bạn cần tôi giúp gì	[]	f	2025-11-27 04:12:34.74018
11	1	buyer	Bạn có sản phẩm này không	["https://hus-ecommerce.s3.ap-southeast-1.amazonaws.com/chat/2025/11/19386d8e8f0c4ec198d7e8f4c4ffb0f7.webp"]	f	2025-11-27 04:12:34.74018
12	1	seller	Tôi không có sản phẩm này	[]	f	2025-11-28 07:28:15.855189
13	1	buyer	Vậy còn màu trắng thì sao	[]	f	2025-11-28 07:28:15.855189
\.
...
SELECT pg_catalog.setval('public.buyer_buyer_id_seq', 6, true);
...
--
-- Name: conversation_conversation_id_seq; Type: SEQUENCE SET; Schema: public; Owner: mywebsite
--

SELECT pg_catalog.setval('public.conversation_conversation_id_seq', 1, true);
...
--
-- Name: message_message_id_seq; Type: SEQUENCE SET; Schema: public; Owner: mywebsite
--

SELECT pg_catalog.setval('public.message_message_id_seq', 13, true);
...
--
-- Name: conversation conversation_pkey; Type: CONSTRAINT; Schema: public; Owner: mywebsite
--
...
--
-- Name: message message_pkey; Type: CONSTRAINT; Schema: public; Owner: mywebsite
--
...
--
-- Name: conversation unique_chat_pair; Type: CONSTRAINT; Schema: public; Owner: mywebsite
--

ALTER TABLE ONLY public.conversation
    ADD CONSTRAINT unique_chat_pair UNIQUE (buyer_id, seller_id);
...
--
-- Name: ix_conversations_last_message_at; Type: INDEX; Schema: public; Owner: mywebsite
--

CREATE INDEX ix_conversations_last_message_at ON public.conversation USING btree (last_message_at);


--
-- Name: ix_messages_conversation_id; Type: INDEX; Schema: public; Owner: mywebsite
--

CREATE INDEX ix_messages_conversation_id ON public.message USING btree (conversation_id);


--
-- Name: ix_messages_created_at; Type: INDEX; Schema: public; Owner: mywebsite
--

CREATE INDEX ix_messages_created_at ON public.message USING btree (created_at);
...
--
-- Name: conversation fk_conversations_buyer; Type: FK CONSTRAINT; Schema: public; Owner: mywebsite
--

ALTER TABLE ONLY public.conversation
    ADD CONSTRAINT fk_conversations_buyer FOREIGN KEY (buyer_id) REFERENCES public.buyer(buyer_id);


--
-- Name: conversation fk_conversations_seller; Type: FK CONSTRAINT; Schema: public; Owner: mywebsite
--

ALTER TABLE ONLY public.conversation
    ADD CONSTRAINT fk_conversations_seller FOREIGN KEY (seller_id) REFERENCES public.seller(seller_id);


--
-- Name: message fk_messages_conversation; Type: FK CONSTRAINT; Schema: public; Owner: mywebsite
--

ALTER TABLE ONLY public.message
    ADD CONSTRAINT fk_messages_conversation FOREIGN KEY (conversation_id) REFERENCES public.conversation(conversation_id);
...
\unrestrict PuW27ExPSLkIlbkEMvd2qcJvb7aEhjwB5W3m5AWIyKJ13WRQDfIqq88lLQPYeHg
