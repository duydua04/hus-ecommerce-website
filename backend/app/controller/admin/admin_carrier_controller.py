...
def admin_list_carriers(
    ...
    """
    return service.list_carrier(q=q, limit=limit, offset=offset)
...
def admin_update_carrier(
    ...
    """Cập nhật thông tin"""
    return service.update_carrier(carrier_id, payload)
...
def admin_delete_carrier(
    ...
    """
    return service.delete_carrier(carrier_id)